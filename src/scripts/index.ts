...
const createCharacterTemplate = (
    character: Rey | Asesor | Luchador | Escudero
) => {
                        ...
                        <div class="card-body">
                            ...
                            <div class="character__overlay">
                                ...
                                <div class="character__actions">
                                    <button class="character__action btn" id="comunicate${
                                        character.name
                                    }">
                                        habla
                                    </button>
...
const displayCharacter = (character: Rey | Asesor | Luchador | Escudero) => {
    const newLi = document.createElement('li');
    newLi.className = 'character col';
    newLi.innerHTML = createCharacterTemplate(character);
    ul?.appendChild(newLi);

    const comunicateButton = document.querySelector(
        `#comunicate${character.name}`
    );
